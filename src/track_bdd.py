...
def main():
    ...
    # 使用我们训练好的多类别模型
    model_path = project_root / "runs/detect/yolov8m_bdd100k_multiclass_v13/weights/best.pt" # 请确保这是您正确的模型路径！
    
    # 输入视频路径 (和之前一样)
    input_video_path = project_root / "data/raw/test_video_traffic.mp4" 
    
    # 定义保存追踪结果的输出视频路径
    output_video_path = project_root / "results/bdd_tracking_output.mp4"
